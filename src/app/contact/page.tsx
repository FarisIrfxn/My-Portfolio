          ...
          <div className="contact-grid-v3">
            <div className="contact-card-v3">
              ...
              <div className="contact-info">
                ...
                <div className="contact-action-wrapper">
                  <a href="mailto:farisbm19@gmail.com" className="contact-link-btn">
            ...
            <div className="contact-card-v3">
              ...
              <div className="contact-info">
                ...
                <div className="contact-action-wrapper">
                  <a href="https://www.linkedin.com/in/farisirfxn" target="_blank" rel="noopener noreferrer" className="contact-link-btn">
            ...
            <div className="contact-card-v3">
              ...
              <div className="contact-info">
                ...
                <div className="contact-action-wrapper">
                  <a href="https://x.com/FarisIrfxns" target="_blank" rel="noopener noreferrer" className="contact-link-btn">
            ...
            <div className="contact-card-v3">
              ...
              <div className="contact-info">
                ...
                <div className="contact-action-wrapper">
                  <a href="https://github.com/FarisIrfxn" target="_blank" rel="noopener noreferrer" className="contact-link-btn">
